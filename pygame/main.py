...
while running:
    ...
    play_space_invaders_text = small_font.render(
        "Play Space Invaders", True, (102, 0, 102)
    )
    screen.blit(
        play_space_invaders_text,
        (
            button_play_game1.x
            + (
                button_play_game1.width // 2 - play_space_invaders_text.get_width() // 2
            ),
            button_play_game1.y
            + (
                button_play_game1.height // 2
                - play_space_invaders_text.get_height() // 2
            ),
        ),
    )
    ...
    screen.blit(
        ...
        (
            button_play_game2.x
            + (button_play_game2.width // 2 - play_missiles.get_width() // 2),
            button_play_game2.y
            + (button_play_game2.height // 2 - play_missiles.get_height() // 2),
        ),
    )
    ...
    screen.blit(
        ...
        (
            button_play_game3.x
            + (button_play_game3.width // 2 - play_platformer.get_width() // 2),
            button_play_game3.y
            + (button_play_game3.height // 2 - play_platformer.get_height() // 2),
        ),
    )
    ...
    screen.blit(
        ...
        (
            button_play_game4.x
            + (button_play_game4.width // 2 - play_flappy_bird.get_width() // 2),
            button_play_game4.y
            + (button_play_game4.height // 2 - play_flappy_bird.get_height() // 2),
        ),
    )
